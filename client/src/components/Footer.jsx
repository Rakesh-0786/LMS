...
//   return (
//     <>
//       <footer className="relative left-0 bottom-0 w-full h-[10vh] py-5 flex flex-col sm:flex-row items-center justify-between text-white bg-gray-800 sm:px-20">
//         <section className="text-lg">
//           Copyright {year} | All rights reserved
//         </section>
//         <section className="flex items-center justify-center gap-5 text-2xl text-white ml-auto">
