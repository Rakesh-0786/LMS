                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    <h3 className="text-4xl font-bold">{allPayments?.count !== undefined ? allPayments.count : 0}</h3>
                            ...
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    {/* {(allPayments?.count !== undefined ? allPayments.count * 499 : 0)} */}
                                </div>
                                        ...
                                        <tr key={course._id}>
                                            ...
                                            <td className="max-w-xs overflow-hidden text-ellipsis whitespace-nowrap">
                                                <textarea
                                                    ...
                                                    readOnly
                                                    className="w-full h-auto bg-transparent resize-none overflow-auto"
                                                >
                                                </textarea>
                                            </td>
                                            {/* items-center */}
                                            <td className="flex justify-center gap-4 ml-1">
